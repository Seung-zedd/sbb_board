...
public class QuestionDetailDto {
    ...
    @Builder
    private QuestionDetailDto(Long id, String subject, String content, SiteUserDto author, LocalDateTime createDate, LocalDateTime modifyDate, int answerCount, int voteCount) {
        this.id = id;
